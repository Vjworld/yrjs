...
const Pages = (() => {
  ...
  function renderSettings() {
    ...
    return `<div class="page-content">
      ...
      <div class="settings-group">
        ...
        <div class="settings-item"><div class="settings-item-info"><span>Version</span></div><span class="text-muted text-sm">YRJS v${APP.version}</span></div>
  ...
  /* ======================================================
     LANDING PAGE (About YRJS)
     ====================================================== */
  function renderLanding() {
    App.setTitle('About YRJS');
    const features = [
      ...
      ['fa-wifi-slash','Works Offline','Zero coverage? No problem. YRJS caches everything locally and syncs automatically when you reconnect.','#0ea5e9','#e0f2fe'],
    ...
    return `<div class="page-content">
      <div class="landing-hero">
        ...
        <p>YRJS is your end-to-end, offline-resilient group travel companion. Track expenses, split bills, settle debts, and connect with fellow travelers — all in one place.</p>
      ...
      <div class="card" style="margin-bottom:var(--space-6)">
        <div class="landing-two-col" style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-6);align-items:start">
          ...
          <div>
            <div style="font-size:2rem;margin-bottom:8px">✅</div>
            <h3 style="color:var(--clr-accent);margin-bottom:8px">YRJS Solution</h3>
            <ul style="font-size:var(--text-sm);color:var(--text-secondary);display:flex;flex-direction:column;gap:8px;padding-left:16px;list-style:disc">
      ...
      <div class="card" style="background:linear-gradient(135deg,var(--clr-primary-10),transparent)">
        <h2 style="font-size:var(--text-xl);font-weight:800;margin-bottom:12px">🏪 Partner with YRJS</h2>
        <p style="color:var(--text-secondary);font-size:var(--text-sm);margin-bottom:16px">
          Reach travelers at the exact moment they're planning their next adventure. YRJS's sponsored listings appear directly in our travel companion app.
        </p>
  ...
  function renderFAQ() {
    ...
    const faqs = [
      ['Is YRJS free to use?', 'Yes! YRJS is completely free for individuals. We monetize through optional partner sponsor placements and premium features.'],
      ['How does the offline mode work?', 'YRJS uses IndexedDB, a browser-native database that persists even without internet. Any data you enter offline is queued and automatically synced to Google Sheets when you reconnect.'],
      ['How is my data secured?', 'All data is stored in your own browser (localStorage/IndexedDB) and in your personal Google Drive via Sheets. YRJS never stores your data on external servers.'],
      ...
      ['How does the debt minimization work?', 'YRJS calculates the net balance for each person, then uses a greedy algorithm to calculate the minimum number of transactions needed to settle all debts. This reduces the number of payments from O(n²) to just O(n).'],
      ...
      ['Can I use YRJS for international trips?', 'Yes! YRJS supports multiple currencies (₹, $, €, £, ¥ and more). You can set your preferred currency in Settings.'],
      ...
      ['How many members can a trip have?', 'YRJS has no hard limit on trip members. It\'s been tested with groups of up to 50 people. Performance is excellent for typical group sizes (5–20).'],
      ['Can I run YRJS from a local file?', 'Yes! Since YRJS is pure HTML/CSS/JS with no backend server required, you can open index.html directly from your computer or host it on GitHub Pages.'],
    ];

    return `<div class="page-content">
      <div class="page-hero">
        <h1>Frequently Asked Questions</h1>
        <p>Everything you need to know about YRJS</p>
      </div>
  ...
  function renderSponsors() {
    App.setTitle('Partner Sponsors', 'Exclusive deals for YRJS travelers');
    const sponsors = [
    ...
    return `<div class="page-content">
      <div class="page-hero">
        ...
        <p>Exclusive deals curated for YRJS travelers</p>
      </div>
  ...
  function renderSuggest() {
    ...
    return `<div class="page-content">
      <div class="page-hero">
        ...
        <p>Help us make YRJS better for everyone. Suggest features or report bugs — every submission is reviewed.</p>
      </div>
      <div class="contact-grid">
        <div class="card">
